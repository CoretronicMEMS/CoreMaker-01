...
#ifndef KX123_REGISTERS_H
#define KX123_REGISTERS_H
...
// WHO_AM_I -value
#define KX012_WHO_AM_I_WAI_ID (0x1A << 0)
#define KX022_WHO_AM_I_WAI_ID (0x14 << 0)
#define KX023_WHO_AM_I_WAI_ID (0x15 << 0)
#define KX23H_WHO_AM_I_WAI_ID (0x1C << 0)
#define KX112_WHO_AM_I_WAI_ID (0x22 << 0)
#define KX122_WHO_AM_I_WAI_ID (0x1B << 0)
#define KX123_WHO_AM_I_WAI_ID (0x20 << 0)
#define KX124_WHO_AM_I_WAI_ID (0x28 << 0)
#define KX222_WHO_AM_I_WAI_ID (0x2C << 0)
...
#define KX122_ODCNTL_IIR_BYPASS (0x01 << 7)
// low pass filter enable
#define KX122_ODCNTL_LPRO (0x01 << 6)
// 12.5Hz
